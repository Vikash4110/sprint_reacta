...
const Section6 = () => {
  return (
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-2 bg-[#0DC9C5]">
        <div className="flex flex-col space-y-6 justify-center p-8 lg:p-36 bg-transparent">
          ...
          <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500">
            <h1 className="text-4xl lg:text-6xl font-bold slide-in-up2 opacity-0 custom_opacity_span_h1">
