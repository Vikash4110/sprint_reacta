  ...
  return (
    <footer className="bg-[#2A2A2A]">
      <div className="grid grid-cols-2">
        <div className="text-white flex flex-col space-y-8 px-36 py-28 pr-40">
          ...
          <div className="flex space-x-6 pt-10 justify-between">
        ...
        <div>
          <div className="flex items-center space-x-4 px-36 py-28 pr-40">
            <div className="grid grid-cols-2">
      ...
      <div className="terms-and-conditions flex p-36 pt-0 justify-between">
