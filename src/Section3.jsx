            ...
            <div className="bg-[#F7F7F7] pt-20 md:pt-40">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="flex justify-center items-center" data-aos="zoom-out" data-aos-delay="200" data-aos-duration="1500">
                        <img src={phonearrowleft} className="h-8 md:h-16 absolute left-0 transform translate-y-32 md:translate-y-96" />
                        <img src={phone} className="h-80 md:h-[50rem]" />
                        <img src={phonearrowright} className="h-8 md:h-16 absolute right-0 transform translate-y-16 md:translate-y-32" />
                    </div>
                    <Section3content
